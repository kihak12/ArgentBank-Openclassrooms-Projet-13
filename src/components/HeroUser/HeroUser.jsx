                    ...
                    <div className={"flex items-center flex-col justify-center my-4.5"}>
                        <div className={"text-white text-3xl font-bold text-center"}>
                            ...
                            <div className={"inline-flex gap-3"}>
                                <input id="firstName" onInput={e => inputFirstName = e.target.value} className={"border-white rounded-lg border-2 focus-visible:outline-0 text-2xl w-52 px-2 py-1"} type="text" defaultValue={user.firstName}/>
                                <input id="lastName" onInput={e => inputLastName = e.target.value} className={"border-white rounded-lg border-2 focus-visible:outline-0 text-2xl w-52 px-2 py-1"} type="text" defaultValue={user.lastName}/>
                            </div>
                        </div>
